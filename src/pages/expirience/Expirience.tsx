...
<Grid container className={style.body} >
  ...
  <Grid  container item xs={12} style={{display:'flex',margin:'2px',justifyContent: 'center',
    ...
    <Box  sx={{ minWidth: 275 }} style={{margin:'5px',padding:'5px',background:'#002B5B',fontFamily:'Montserrat, serif'}}> <h3>
                Skills
            </h3>
          <Box >
